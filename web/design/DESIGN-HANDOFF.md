# b6a03d1e-460d-43a1-8f20-479dd3c539ad implementation handoff

This archive is the source of truth for turning the design into production code. Start from `design-system.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `design-system.html`
...
- A single self-contained `design-system.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `design-system.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
1. Inspect `design-system.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
