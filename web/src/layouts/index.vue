...
<template>
  <div class="layout">
    <div id="app-main">
      <Header />
      <div class="wrapper">
        <div v-if="!settingsStore.isTabbarHorizontal" class="sidebar-container" :class="{ show: settingsStore.mode === 'mobile' && !settingsStore.settings.menu.subMenuCollapse }">
          <!-- <MainSidebar /> -->
          <SubSidebar />
        </div>
      ...
      <el-backtop :right="20" :bottom="20" :title="t('layout.backTop')" />
    </div>
    <Search />
    <HotkeysIntro />
