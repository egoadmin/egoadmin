...
const useSettingsStore = defineStore(
  ...
  () => {
    ...
    // 获取导航栏方向
    const isTabbarHorizontal = computed(() => {
      return settings.value.app.tabbarDirection === 'horizontal'
    })
    // 更改导航栏方向
    function switchNavDirection(dir: 'horizontal' | 'vertical') {
      settings.value.app.tabbarDirection = dir
      if (dir === 'horizontal') {
