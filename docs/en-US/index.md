...
features:
  - icon: 🤖
    title: Agent First
    details: Built-in structured AI skill docs cover proto contracts, permissions, distributed transactions, data scopes, migrations and shutdown flows so agents follow project conventions.
  - icon: 📋
...
The English guide source files are maintained under `docs/guide/en-US`.

Start here:

- [Getting Started](/en-US/guide/getting-started)
- [Feature Overview](/en-US/guide/features)
- [Microservice Architecture](/en-US/guide/architecture)
- [API Development Workflow](/en-US/guide/api-development)
- [Design Assets](/en-US/guide/design-resources)
